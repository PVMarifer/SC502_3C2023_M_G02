...
<head>
  ...
  <title>SG GANADERIA | PARTOS</title>
          ...
          <div class="row mb-2">
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active">Añadir Parto</li>
              </ol>
            </div>
            <div class="col-sm-6">
              <h1 class="m-0"></h1>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" name="numeroArete"
                            placeholder="Ingrese el número del Arete" required>
                        </div>
                      </div>
                      <div class="col-12">
                        <div class="form-group">
          ...
          <div class="row mb-5" id="form-modificar">
            ...
            <div class="col-8">
              <div class="card " style="background-color: grey;">
                <div class="card-header text-center">
                  <h3 class="card-title text-white">Modificar Parto</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                  ...
                  <div class="card-body text-white ">
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="form-group">
                          <label for="">Tipo de Parto</label>
                          <input type="text" class="form-control" name="TipoParto" placeholder="Ingrese los sintomas" required>
                        </div>
                      </div>
