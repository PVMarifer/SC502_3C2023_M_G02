  ...
  <div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card-header text-center">
            <h3 class="card-title text-white">Nueva Vaca</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form>
            ...
            <div class="form-group">
                ...
                <option selected="selected">stardar</option>
                <option>#1</option>
                <option>#2</option>
                <option>#3</option>
            ...
            <div class="form-group">
                <label>Peso</label>
                <input type="text" class="form-control" id="" placeholder="Ingrese el Peso de la vaca">
