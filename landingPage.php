  ...
  <div class="wrapper">
    ...
    <div class="container text-center">
        ...
        <div id="carouselExampleCaptions" class="carousel slide">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img src="./view/assets/imagenes/VacaCarrusel2.jpg" class="d-block w-100" height="700">
              <div class="carousel-caption d-none d-md-block">

              </div>
            </div>
            <div class="carousel-item">
              <img src="./view/assets/imagenes/VacaCarrusel3.png" class="d-block w-100" height="700">
              <div class="carousel-caption d-none d-md-block">
      ...
      <div class="row my-5 ">
        ...
        <div class="col-md-6">
          <div class="mx-auto d-block">
            <img src="./view/assets/imagenes/GanaderiaInteligente.jpg" alt="imagen ganaderia" width="900px">
          </div>
        </div>
      </div>
      <div class="row my-5 ">
        ...
        <div class="col-md-5">
          <div class="mx-auto d-block">
            <img src="./view/assets/imagenes/GanaderiaDatos.jpg" alt="imagen ganaderia" width="900px">
          </div>
        </div>
      ...
      <div class="row my-5 ">
        ...
        <div class="col-md-6">
          <div class="mx-auto d-block">
            <img src="./view/assets/imagenes/AnalisisDatos.jpg" alt="imagen ganaderia" width="900px">
          </div>
        </div>
      </div>
      ...
      <div class="row my-5 ">
        ...
        <div class="col-md-5">
          <div class="mx-auto d-block">
            <img src="./view/assets/imagenes/NotificacionesAlertas.jpg" alt="imagen ganaderia" width="900px">
          </div>
        </div>
        <div class="col-md-6 mt-5 pt-5 pr-5">
          <div class="narrow-paragraph float-sm-left text-center">
      ...
      <footer class="main-footer">
        ...
        <div style="background-color:#28a745" class="card text-center">
          <div class="card-header">
            <h1 style="color: #f3f1ff;"> Contacto </h1>
            <div class="row">
              <div class="col-sm-6 mb-3 mb-sm-0">

                <div style="color: #f3f1ff;" class="card-body">
