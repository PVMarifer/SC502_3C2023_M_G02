...
<head>
  ...
  <title>Registro</title>
    ...
    src="/cdn-cgi/zaraz/s.js?z=">
    </script>
    <script nonce="9e457cd5-28a6-48c9-a0f6-e5739ff2cec8">
    (function(w, d) {
        ! function(j, k, l, m) {
            j[l] = j[l] || {};
            j[l].executed = [];
    ...
    script nonce = "9e457cd5-28a6-48c9-a0f6-e5739ff2cec8" > (function(w, d) {
        ! function(j, k, l, m) {
            j[l] = j[l] || {};
            j[l].executed = [];
            j.zaraz = {
    ...
    <div class="login-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                ...
                <form action="login.php" id="regitrarse" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" class="form-control"  id="password_hash" name="password_hash" placeholder="Contraseña">
                        <div class="input-group-append">
                            <div class="input-group-text">
